...
// let mathScore = prompt("수학 점수를 입력 하세요"); //'60'
// let engScore = prompt("영어 점수를 입력 하세요"); //'80'
// let mathNumber = Number(mathScore)
// let engNumber = Number(engScore)
// // let avg = (mathScore + engScore) / 2; //'6080' /2 >NaN이 나오는 게 맞으나 JS가 자동 형변환 시킴
