...
app.get("/getCookie", (req, res) => {
  //   console.log(req.cookies); // ver1. 암호화 되지 않은 쿠키일 때 cookies에 담겨서 옴
  //   res.send(req.cookies);
  console.log(req.signedCookies); // ver2. 암호화 된 쿠키일 때 signedCookies에 담겨서 옴
